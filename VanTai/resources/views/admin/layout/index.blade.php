...
<head>
	...
	<!-- DataTables CSS -->
	<link href="vantai_asset/bower_components/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.css" rel="stylesheet">

	<!-- DataTables Responsive CSS -->
	<link href="vantai_asset/bower_components/datatables-responsive/css/dataTables.responsive.css" rel="stylesheet">

	<link rel="stylesheet" href="vantai_asset/css/cssad.css">
</head>
...
<body>
	...
	<script src="vantai_asset/bower_components/DataTables/media/js/jquery.dataTables.min.js"></script>
	<script src="vantai_asset/bower_components/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.min.js"></script>
	...
	<script type="text/javascript" language="javascript" src="vantai_asset/ckeditor/ckeditor.js" ></script>
